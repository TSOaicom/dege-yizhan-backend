<template>
  <view class="uni-uploader-wrapper">
    ...
    >
      <button
          class="py-3 bg-primary-500 hover:bg-primary-600 text-white text-center text-lg rounded-xl mb-2  transition-colors"
          size="mini">{{ t('common.select_text') }}</button>
    </uni-file-picker>
  </view>
</template>
...
const effectiveTitle = computed(() =>
    props.title || proxy.$tt('image_upload.upload_title')
)

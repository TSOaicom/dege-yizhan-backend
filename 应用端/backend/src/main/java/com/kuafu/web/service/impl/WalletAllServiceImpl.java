...
@Autowired
private WalletAllMapper taskInfoAllMapper;


@Override
public List<WalletAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<WalletAll> queryWrapper) {

        LambdaQueryWrapper<WalletAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<WalletAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<WalletAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<WalletAll> queryWrapper) {
        LambdaQueryWrapper<WalletAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<WalletAll> page, PageRequest pageRequest, LambdaQueryWrapper<WalletAll> queryWrapper) {

...
@Autowired
    ...
    public BaseResponse page( UserInfoAllPageVO pageVO){
                ...
                queryWrapper.and(wrapper -> {
                    for (int i = 0; i < strings.length; i++) {
                        ...
                        if (StringUtils.isNotEmpty(s)) {
                            ...
                            wrapper.like(UserInfoAll::getTypeName, trim);
        ...
        if(StringUtils.isNotEmpty(pageVO.getCarPlate())) {
                queryWrapper.like(UserInfoAll::getCarPlate, pageVO.getCarPlate());
            }
        ...
        if(StringUtils.isNotEmpty(pageVO.getCity())) {
                queryWrapper.like(UserInfoAll::getCity, pageVO.getCity());
            }
        ...
        if(StringUtils.isNotEmpty(pageVO.getRealName())) {
                ...
                queryWrapper.and(wrapper -> {
                    for (int i = 0; i < strings.length; i++) {
                        ...
                        if (StringUtils.isNotEmpty(s)) {
                            final String trim = s.trim();
                            wrapper.like(UserInfoAll::getRealName, trim);
                            if (i != strings.length - 1) {
                                wrapper.or();
                            }
                        }
        ...
        if(StringUtils.isNotEmpty(pageVO.getStatus())) {
                queryWrapper.like(UserInfoAll::getStatus, pageVO.getStatus());
            }

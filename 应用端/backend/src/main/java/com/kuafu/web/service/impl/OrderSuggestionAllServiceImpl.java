...
@Autowired
private OrderSuggestionAllMapper taskInfoAllMapper;


@Override
public List<OrderSuggestionAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderSuggestionAll> queryWrapper) {

        LambdaQueryWrapper<OrderSuggestionAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<OrderSuggestionAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<OrderSuggestionAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<OrderSuggestionAll> queryWrapper) {
        LambdaQueryWrapper<OrderSuggestionAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<OrderSuggestionAll> page, PageRequest pageRequest, LambdaQueryWrapper<OrderSuggestionAll> queryWrapper) {

...
import com.kuafu.web.mapper.InviteRecordAllMapper;
 ...
 */
@Slf4j
@Service("InviteRecordAll")
public class InviteRecordAllServiceImpl extends ServiceImpl<InviteRecordAllMapper, InviteRecordAll> implements IInviteRecordAllService {
@Autowired
private InviteRecordAllMapper taskInfoAllMapper;


@Override
public List<InviteRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<InviteRecordAll> queryWrapper) {

        LambdaQueryWrapper<InviteRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<InviteRecordAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<InviteRecordAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<InviteRecordAll> queryWrapper) {
        LambdaQueryWrapper<InviteRecordAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<InviteRecordAll> page, PageRequest pageRequest, LambdaQueryWrapper<InviteRecordAll> queryWrapper) {

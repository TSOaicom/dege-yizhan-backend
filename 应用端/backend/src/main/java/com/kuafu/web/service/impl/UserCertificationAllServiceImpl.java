...
import com.kuafu.web.mapper.UserCertificationAllMapper;
 ...
 */
@Slf4j
@Service("UserCertificationAll")
public class UserCertificationAllServiceImpl extends ServiceImpl<UserCertificationAllMapper, UserCertificationAll> implements IUserCertificationAllService {
@Autowired
private UserCertificationAllMapper taskInfoAllMapper;


@Override
public List<UserCertificationAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<UserCertificationAll> queryWrapper) {

        LambdaQueryWrapper<UserCertificationAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<UserCertificationAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<UserCertificationAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<UserCertificationAll> queryWrapper) {
        LambdaQueryWrapper<UserCertificationAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<UserCertificationAll> page, PageRequest pageRequest, LambdaQueryWrapper<UserCertificationAll> queryWrapper) {

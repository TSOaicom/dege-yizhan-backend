...
import com.kuafu.web.mapper.MessageCenterAllMapper;
 ...
 */
@Slf4j
@Service("MessageCenterAll")
public class MessageCenterAllServiceImpl extends ServiceImpl<MessageCenterAllMapper, MessageCenterAll> implements IMessageCenterAllService {
@Autowired
private MessageCenterAllMapper taskInfoAllMapper;


@Override
public List<MessageCenterAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<MessageCenterAll> queryWrapper) {

        LambdaQueryWrapper<MessageCenterAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<MessageCenterAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<MessageCenterAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<MessageCenterAll> queryWrapper) {
        LambdaQueryWrapper<MessageCenterAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<MessageCenterAll> page, PageRequest pageRequest, LambdaQueryWrapper<MessageCenterAll> queryWrapper) {

...
@Autowired
private FeedbackAllMapper taskInfoAllMapper;


@Override
public List<FeedbackAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<FeedbackAll> queryWrapper) {

        LambdaQueryWrapper<FeedbackAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<FeedbackAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<FeedbackAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<FeedbackAll> queryWrapper) {
        LambdaQueryWrapper<FeedbackAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<FeedbackAll> page, PageRequest pageRequest, LambdaQueryWrapper<FeedbackAll> queryWrapper) {
